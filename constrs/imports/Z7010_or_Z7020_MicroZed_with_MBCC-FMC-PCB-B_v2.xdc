...
# User LEDs - Bank 34
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN R19 [get_ports {LED[0]}];  # "R19.JX1_SE_0.JX1.9.LED0"
set_property PACKAGE_PIN V13 [get_ports {LED[1]}];  # "V13.JX1_LVDS_2_N.JX1.19.LED1"
...
# JB Pmod - Bank 34
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T11 [get_ports {VGA_GREEN_O[0]}];  # "T11.JX1_LVDS_0_P.JX1.11.JB0-1_P" - JB - Pin 1
set_property PACKAGE_PIN T10 [get_ports {VGA_GREEN_O[1]}];  # "T10.JX1_LVDS_0_N.JX1.13.JB0-1_N" - JB - Pin 2
set_property PACKAGE_PIN T12 [get_ports {VGA_GREEN_O[2]}];  # "T12.JX1_LVDS_1_P.JX1.12.JB2-3_P" - JB - Pin 3
set_property PACKAGE_PIN U12 [get_ports {VGA_GREEN_O[3]}];  # "U12.JX1_LVDS_1_N.JX1.14.JB2-3_N" - JB - Pin 4
set_property PACKAGE_PIN V12 [get_ports {VGA_HSYNC_O}];  # "V12.JX1_LVDS_3_P.JX1.18.JB4-5_P" - JB - Pin 7
set_property PACKAGE_PIN W13 [get_ports {VGA_VSYNC_O}];  # "W13.JX1_LVDS_3_N.JX1.20.JB4-5_N" - JB - Pin 8
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN U19 [get_ports {LVDS_CLK_N}];  # "U19.JX1_LVDS_11_N.JX1.44.CLK0_M2C_N"
set_property PACKAGE_PIN U18 [get_ports {LVDS_CLK_P}];  # "U18.JX1_LVDS_11_P.JX1.42.CLK0_M2C_P"
...
set_property PACKAGE_PIN N18 [get_ports {VDD_18_EN}];  # "N18.JX1_LVDS_12_P.JX1.47.LA00_CC_P"
...
set_property PACKAGE_PIN R14 [get_ports {LVDS_SYNC_N}];  # "R14.JX1_LVDS_5_N.JX1.26.LA02_N"
set_property PACKAGE_PIN P14 [get_ports {LVDS_SYNC_P}];  # "P14.JX1_LVDS_5_P.JX1.24.LA02_P"
...
set_property PACKAGE_PIN Y14 [get_ports {LVDS_DIN3_N}];  # "Y14.JX1_LVDS_7_N.JX1.32.LA04_N"
set_property PACKAGE_PIN W14 [get_ports {LVDS_DIN3_P}];  # "W14.JX1_LVDS_7_P.JX1.30.LA04_P"
...
set_property PACKAGE_PIN U15 [get_ports {LVDS_DIN2_N}];  # "U15.JX1_LVDS_10_N.JX1.43.LA07_N"
set_property PACKAGE_PIN U14 [get_ports {LVDS_DIN2_P}];  # "U14.JX1_LVDS_10_P.JX1.41.LA07_P"
...
set_property PACKAGE_PIN W16 [get_ports {LVDS_DIN1_N}];  # "W16.JX1_LVDS_17_N.JX1.64.LA11_N"
set_property PACKAGE_PIN V16 [get_ports {LVDS_DIN1_P}];  # "V16.JX1_LVDS_17_P.JX1.62.LA11_P"
...
set_property PACKAGE_PIN W19 [get_ports {LVDS_DIN0_N}];  # "W19.JX1_LVDS_21_N.JX1.76.LA15_N"
set_property PACKAGE_PIN W18 [get_ports {LVDS_DIN0_P}];  # "W18.JX1_LVDS_21_P.JX1.74.LA15_P"
...
set_property PACKAGE_PIN D18 [get_ports {CLK_PLL}];  # "D18.JX2_LVDS_2_N.JX2.25.LA19_N"
...
set_property PACKAGE_PIN E19 [get_ports {SPI_MOSI}];  # "E19.JX2_LVDS_4_N.JX2.31.LA21_N"
set_property PACKAGE_PIN E18 [get_ports {SPI_CLK}];  # "E18.JX2_LVDS_4_P.JX2.29.LA21_P"
...
set_property PACKAGE_PIN M20 [get_ports {CAM_RESET_N}];  # "M20.JX2_LVDS_7_N.JX2.38.LA24_N"
set_property PACKAGE_PIN M19 [get_ports {SPI_SS_N}];  # "M19.JX2_LVDS_7_P.JX2.36.LA24_P"
...
set_property PACKAGE_PIN F20 [get_ports {TRIGGER_1}];  # "F20.JX2_LVDS_15_N.JX2.64.LA28_N"
set_property PACKAGE_PIN F19 [get_ports {TRIGGER_2}];  # "F19.JX2_LVDS_15_P.JX2.62.LA28_P"
...
set_property PACKAGE_PIN J14 [get_ports {SPI_MISO}];  # "J14.JX2_LVDS_18_N.JX2.75.LA30_N"
set_property PACKAGE_PIN K14 [get_ports {TRIGGER_0}];  # "K14.JX2_LVDS_18_P.JX2.73.LA30_P"
...
set_property PACKAGE_PIN N16 [get_ports {MONITOR_0}];  # "N16.JX2_LVDS_20_N.JX2.83.LA32_N"
set_property PACKAGE_PIN N15 [get_ports {MONITOR_1}];  # "N15.JX2_LVDS_20_P.JX2.81.LA32_P"
set_property PACKAGE_PIN L15 [get_ports {VDD_33_EN_0}];  # "L15.JX2_LVDS_21_N.JX2.84.LA33_N"
set_property PACKAGE_PIN L14 [get_ports {VDD_33_EN_1}];  # "L14.JX2_LVDS_21_P.JX2.82.LA33_P"


# ----------------------------------------------------------------------------
# User LEDs - Bank 35
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN K16 [get_ports {LED[2]}];  # "K16.JX2_LVDS_23_P.JX2.88.LED2"
set_property PACKAGE_PIN M15 [get_ports {LED[3]}];  # "M15.JX2_LVDS_22_N.JX2.89.LED3"
...
# JA Pmod - Bank 35
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN L16 [get_ports {VGA_RED_O[0]}];  # "L16.JX2_LVDS_10_P.JX2.47.JA0-1_P" - JA - Pin 1
set_property PACKAGE_PIN L17 [get_ports {VGA_RED_O[1]}];  # "L17.JX2_LVDS_10_N.JX2.49.JA0-1_N" - JA - Pin 2
set_property PACKAGE_PIN G14 [get_ports {VGA_RED_O[2]}];  # "G14.JX2_SE_0.JX2.13.JA2" - JA - Pin 3
set_property PACKAGE_PIN J15 [get_ports {VGA_RED_O[3]}];  # "J15.JX2_SE_1.JX2.14.JA3" - JA - Pin 4
set_property PACKAGE_PIN B19 [get_ports {VGA_BLUE_O[0]}];  # "B19.JX2_LVDS_1_P.JX2.18.JA4-5_P" - JA - Pin 7
set_property PACKAGE_PIN A20 [get_ports {VGA_BLUE_O[1]}];  # "A20.JX2_LVDS_1_N.JX2.20.JA4-5_N" - JA - Pin 8
set_property PACKAGE_PIN C20 [get_ports {VGA_BLUE_O[2]}];  # "C20.JX2_LVDS_0_P.JX2.17.JA6-7_P" - JA - Pin 9
set_property PACKAGE_PIN B20 [get_ports {VGA_BLUE_O[3]}];  # "B20.JX2_LVDS_0_N.JX2.19.JA6-7_N" - JA - Pin 10


# ----------------------------------------------------------------------------
# JY Pmod - Bank 13 (Available on Z7020 device only)
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN U7 [get_ports {JY0-1_P}];  # "U7.BANK13_LVDS_0_P.JX1.87.JY0-1_P" - JY - Pin 1
set_property PACKAGE_PIN V7 [get_ports {JY0-1_P}];  # "V7.BANK13_LVDS_0_N.JX1.89.JY0-1_N" - JY - Pin 2
set_property PACKAGE_PIN T9 [get_ports {JY2-3_P}];  # "T9.BANK13_LVDS_1_P.JX1.88.JY2-3_P" - JY - Pin 3
set_property PACKAGE_PIN U10 [get_ports {JY2-3_N}];  # "U10.BANK13_LVDS_1_N.JX1.90.JY2-3_N" - JY - Pin 4
set_property PACKAGE_PIN V8 [get_ports {PB[2]}];  # "V8.BANK13_LVDS_2_P.JX1.91.JY4-5_P" - JY - Pin 7
set_property PACKAGE_PIN W8 [get_ports {PB[3]}];  # "W8.BANK13_LVDS_2_N.JX1.93.JY4-5_N" - JY - Pin 8
set_property PACKAGE_PIN T5 [get_ports {PB[4]}];  # "T5.BANK13_LVDS_3_P.JX1.92.JY6-7_P" - JY - Pin 9
set_property PACKAGE_PIN U5 [get_ports {PB[5]}];  # "U5.BANK13_LVDS_3_N.JX1.94.JY6-7_N" - JY - Pin 10


# ----------------------------------------------------------------------------
# JZ Pmod - Bank 13 (Available on Z7020 device only)
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y12 [get_ports {SWITCH[0]}];  # "Y12.BANK13_LVDS_4_P.JX2.93.JZ0-1_P" - JZ - Pin 1
set_property PACKAGE_PIN Y13 [get_ports {SWITCH[1]}];  # "Y13.BANK13_LVDS_4_N.JX2.95.JZ0-1_N" - JZ - Pin 2
set_property PACKAGE_PIN V11 [get_ports {SWITCH[2]}];  # "V11.BANK13_LVDS_5_P.JX2.94.JZ2-3_P" - JZ - Pin 3
set_property PACKAGE_PIN V10 [get_ports {SWITCH[3]}];  # "V10.BANK13_LVDS_5_N.JX2.96.JZ2-3_N" - JZ - Pin 4
...
set_property IOSTANDARD LVDS_25 [get_ports {LVDS_CLK_N LVDS_CLK_P LVDS_SYNC_N LVDS_SYNC_P LVDS_DIN3_N LVDS_DIN3_P LVDS_DIN2_N LVDS_DIN2_P LVDS_DIN1_N LVDS_DIN1_P LVDS_DIN0_N LVDS_DIN0_P}];

# Set the bank voltage for IO Bank 35 to 2.5V by default.
set_property IOSTANDARD LVCMOS25 [get_ports -of_objects [get_iobanks 35]];

# Set the bank voltage for IO Bank 13 to 2.5V by default. (I/O bank available on Z7020 device only)
